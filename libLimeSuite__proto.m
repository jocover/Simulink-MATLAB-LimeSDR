...
fcns.thunkname{fcnNum}='int32voidPtr_Booluint64LPF_FixedBWThunk';fcns.name{fcnNum}='LMS_SetLPFBWFixed'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'voidPtr', 'bool', 'uint64', 'LPF_FixedBW'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='int32voidPtr_Booluint64uint64_BoolThunk';fcns.name{fcnNum}='LMS_SetNCOIndex'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'voidPtr', 'bool', 'uint64', 'uint64', 'bool'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='int32uint64doubledoubledoublevoidPtrThunk';fcns.name{fcnNum}='LMS_GenerateLPFCoef'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'uint64', 'double', 'double', 'double', 'doublePtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='int32voidPtruint64voidPtrThunk';fcns.name{fcnNum}='LMS_GetVCORange'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'voidPtr', 'uint64', 'lms_range_tPtr'};fcnNum=fcnNum+1;
%  int __cdecl LMS_SetVCORange ( lms_device_t * dev , size_t vco_id , lms_range_t range );
fcns.thunkname{fcnNum}='int32voidPtruint64lms_range_tThunk';fcns.name{fcnNum}='LMS_SetVCORange'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'voidPtr', 'uint64', 'lms_range_t'};fcnNum=fcnNum+1;
